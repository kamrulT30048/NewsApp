...
import com.kamrulhasan.topnews.databinding.FragmentBusinessBinding
...
class BusinessFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        _binding = FragmentBusinessBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        //livedata observer
        viewModel.businessArticle.observe(viewLifecycleOwner) {
            articleList = it
            tempArticleList = it
        ...
        binding.swipeContainer.setOnRefreshListener {
            ...
            if (articleList.isEmpty() && !connection) {
                ...
                binding.tvCloudOff.visibility = View.GONE
                binding.tvNoItem.visibility = View.GONE
                viewModel.hitBusinessArticleAPI()
