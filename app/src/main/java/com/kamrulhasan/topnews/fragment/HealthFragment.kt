...
import com.kamrulhasan.topnews.databinding.FragmentHealthBinding
...
class HealthFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        _binding = FragmentHealthBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        //observe livedata
        viewModel.healthArticle.observe(viewLifecycleOwner) {
            articleList = it
            tempArticleList = it
